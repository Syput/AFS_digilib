          ...
          <div class="row">
            <div class="col-lg-4 col-xs-6">
              <div class="small-box bg-green">
                ...
                <a href="<?php echo base_url('index.php/dosen/buku') ?>" class="small-box-footer" style="text-shadow: 3px 3px 8px black;"><b>Selengkapnya</b> <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
			 <div class="col-lg-4 col-xs-6">
              <div class="small-box bg-red">
                ...
                <a href="<?php echo base_url('index.php/dosen/penelitian') ?>" class="small-box-footer" style="text-shadow: 3px 3px 8px black;"><b>Selengkapnya</b><i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <div class="col-lg-4 col-xs-6">
