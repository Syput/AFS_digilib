  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Statistik
        <small>Pembaca</small><hr>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-users"></i> Statistik</a></li>
        <li class="active">Statistik Pembaca</li>
      </ol>
    </section>
		...
		<table class="table" style="margin-top: 10px;background:#ffffff;border-radius:20px">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td><?php echo $no++; ?></td>
                        <td><a href="<?= base_url().'index.php/pustakawan/user/info/'.$b->pembaca; ?>"><?= $b->pembaca; ?></a></td>
						<!--<td><?php echo $b->pustaka; ?></td>-->
                        <td><?php echo $b->jumlah." Bacaan"; ?></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
