          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-xs-6">
              <div class="small-box bg-<?php echo $warna[$i];?>">
               ...
               <a href="<?php echo base_url('index.php/anggota/penelitian/kelola_penelitian/').$abjad ?>" class="small-box-footer" style="text-shadow: 3px 3px 8px black;">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a> 
