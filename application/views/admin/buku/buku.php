...
function tampil(){
     ...
     table = $('#databuku').DataTable({
        ...
        "ajax": {
            "url": '<?php echo base_url()."index.php/pustakawan/buku/ambilData"?>',
            "type": "POST"
        },
...
function tambah(){
        $.ajax({
            url: '<?php echo base_url()."index.php/pustakawan/buku/formtambah"?>',
            dataType: 'json',
...
//-----modal update data
     function edit(kode){
          $.ajax({
            type:'POST',
            url: '<?php echo base_url()."index.php/pustakawan/buku/formupdate"?>',
            data: {kode_b : kode},
            dataType: 'json',
            success : function(response){
                if(response.sukses){
...
//----function delete
    ...
    function read_pustaka(judul,kode){
       // alert(judul);
        var x = window.open('<?php echo base_url()."index.php/pustakawan/buku/baca/";?>' + judul + '/' + kode,'_blank');
        x.focus();
	  ...
	  swal({
            ...
            .then((willDelete) => {
              if (willDelete) {
                  $.ajax({
                    type:'POST',
                    url: '<?php echo base_url()."index.php/pustakawan/buku/tambah_sitasi"?>',
                    data: {kode_s:kode},
                    dataType:'json',
                    success:function(){
   ...
   function transaksi(kode){
          $.ajax({
            type:'POST',
            url: '<?php echo base_url()."index.php/pustakawan/buku/formtransaksi"?>',
            data: {kode_b : kode},
            dataType: 'json',
            success : function(response){
                if(response.sukses){
