				...
				<div class="form-group">
				 ...
				 <div class="form-group">
					...
					<div class="form-group">
                        ...
                        <input type="text" class="form-control" name="peminjam" placeholder=" Isi NIM / NIDN Peminjam" required>
                   </div>
                    <div class="form-group">
                        <label>Note</label>
       ...
       $('.formtransaksi').submit(function(e){
          // e.preventDefault();
           $.ajax({
               ...
               type :   'POST',
               url  :   '<?php echo base_url()."index.php/pustakawan/buku/tambah_transaksi"?>',
			   ...
			   error:function(data){
				    swal("Transaksi peminjaman gagal!","Data dengan NIM / NIDN tersebut tidak terdaftar", "error");
			   }
