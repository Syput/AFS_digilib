			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<label>Kode</label>
						<input type="text" class="form-control" name="kode" placeholder="Kode" value="<?php echo $this->session->userdata('kodep')?>" readonly>
					</div>
					<div class="form-group">
						<label>Indeks Kata Tangkap</label>
						<input type="text" class="form-control" name="huruf" value="<?php echo $this->session->userdata('abjad');?>"readonly>
					</div>
					<div class="form-group">
						<label>Judul</label>
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="penerbit" placeholder="Penerbit" value="STMIK MARDIRA INDONESIA" readonly>
					</div>
					<div class="form-group">
						<label>Tahun</label>
       ...
       $('.formtambah').submit(function(e){
          // e.preventDefault();
           $.ajax({
               ...
               type :   'POST',
               url  :   '<?php echo base_url()."index.php/pustakawan/penelitian/tambah_data"?>',
