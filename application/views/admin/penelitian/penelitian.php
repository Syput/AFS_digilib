...
tampil();     
 ...
 function tampil(){
     table = $('#databuku').DataTable({
        ...
        "ajax": {
            "url": '<?php echo base_url()."index.php/pustakawan/penelitian/ambilData"?>',
            "type": "POST"
        },
...
//------modal tambah data 
        $.ajax({
            url: '<?php echo base_url()."index.php/pustakawan/penelitian/formtambah"?>',
            dataType: 'json',
...
//-----modal update data
     function edit(kode){
          $.ajax({
            type:'POST',
            url: '<?php echo base_url()."index.php/pustakawan/penelitian/formupdate"?>',
            data: {kode_p : kode},
            dataType: 'json',
            success : function(response){
                if(response.sukses){
...
//----function delete
      ...
      swal({
            ...
            .then((willDelete) => {
              if (willDelete) {
                  $.ajax({
                    type:'POST',
                    url: '<?php echo base_url()."index.php/pustakawan/penelitian/delete_data"?>',
                    data: {kode_p:kode},
                    dataType:'json',
                    success:function(){
  ...
  function read_pustaka(judul,kode){
       // alert(judul);
        var x = window.open('<?php echo base_url()."index.php/pustakawan/penelitian/baca/";?>' + judul + '/' + kode,'_blank');
        x.focus();
	  ...
	  swal({
            ...
            .then((willDelete) => {
              if (willDelete) {
                  $.ajax({
                    type:'POST',
                    url: '<?php echo base_url()."index.php/pustakawan/penelitian/tambah_sitasi"?>',
                    data: {kode_s:kode},
                    dataType:'json',
                    success:function(){
  ...
  function transaksi_b(kode){
          $.ajax({
            type:'POST',
            url: '<?php echo base_url()."index.php/pustakawan/penelitian/formtransaksi"?>',
            data: {kode_b : kode},
            dataType: 'json',
            success : function(response){
                if(response.sukses){
